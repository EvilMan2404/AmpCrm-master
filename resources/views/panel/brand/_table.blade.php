        ...
        <tr>
            <th>
                <a class="text-light" style="text-decoration: underline"
                   href="{{ request()->fullUrlWithQuery((app('request')->get('sort_by') === 'id' && app('request')->get('order') === 'desc') ? ['sort_by' => 'id','order' => 'asc'] : ['sort_by' => 'id','order' => 'desc']) }} ">@lang('brand.id')</a>
            ...
            <th>
                <a class="text-light" style="text-decoration: underline"
                   href="{{ request()->fullUrlWithQuery((app('request')->get('sort_by') === 'name' && app('request')->get('order') === 'desc') ? ['sort_by' => 'name','order' => 'asc'] : ['sort_by' => 'name','order' => 'desc']) }} ">@lang('brand.name')</a>
            ...
            <tr>
                ...
                <td>
                    @can('policy','guard_brand_edit')
                        <a href="{{route('brand.index',['edit' => $item->id,$path])}}" class="action-icon"> <i
