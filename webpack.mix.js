...
const third_party_assets = {
    css_js: [
        ...
        },
        {
            ...
            "assets": ["./node_modules/jquery-nice-select/js/jquery.nice-select.min.js", "./node_modules/jquery-nice-select/css/nice-select.css"]
        },
        ...
        },
        {
            ...
            "assets": ["./node_modules/ion-rangeslider/js/ion.rangeSlider.min.js", "./node_modules/ion-rangeslider/css/ion.rangeSlider.css"]
        },
        {
            "name": "toastr",
        ...
        {
            "name": "switchery",
            "assets": ["./node_modules/mohithg-switchery/dist/switchery.min.js", "./node_modules/mohithg-switchery/dist/switchery.min.css"]
        },
        ...
        {
            "name": "custombox",
            "assets": ["./node_modules/custombox/dist/custombox.min.js", "./node_modules/custombox/dist/custombox.min.css"]
        },
        {
            "name": "jquery-toast",
            "assets": ["./node_modules/jquery-toast-plugin/dist/jquery.toast.min.js", "./node_modules/jquery-toast-plugin/dist/jquery.toast.min.css"]
        },
        ...
        {
            "name": "nestable2",
            "assets": ["./node_modules/nestable2/dist/jquery.nestable.min.js", "./node_modules/nestable2/dist/jquery.nestable.min.css"]
        },
        {
            "name": "hopscotch",
            "assets": ["./node_modules/hopscotch/dist/js/hopscotch.min.js", "./node_modules/hopscotch/dist/css/hopscotch.min.css"]
        },
        {
            "name": "ladda",
            "assets": ["./node_modules/ladda/js/spin.js", "./node_modules/ladda/js/ladda.js", "./node_modules/ladda/dist/ladda-themeless.min.css"]
        },
        {
        ...
        {
            "name": "rickshaw",
            "assets": ["./node_modules/rickshaw/rickshaw.min.js", "./node_modules/rickshaw/rickshaw.min.css"]
        },
        ...
        {
            "name": "rwd-table",
            "assets": ["./node_modules/RWD-Table-Patterns/dist/js/rwd-table.min.js", "./node_modules/RWD-Table-Patterns/dist/css/rwd-table.min.css"]
        },
        {
            "name": "footable",
            "assets": ["./node_modules/footable/dist/footable.all.min.js", "./node_modules/footable/css/footable.core.min.css"]
        },
        {
            "name": "bootstrap-table",
            "assets": ["./node_modules/bootstrap-table/dist/bootstrap-table.min.js", "./node_modules/bootstrap-table/dist/bootstrap-table.min.css"]
        },
        {
            "name": "tablesaw",
            "assets": ["./node_modules/tablesaw/dist/tablesaw.js", "./node_modules/tablesaw/dist/tablesaw.css"]
        },
        {
            "name": "jsgrid",
            "assets": ["./node_modules/jsgrid/dist/jsgrid.min.js", "./node_modules/jsgrid/dist/jsgrid.min.css", "./node_modules/jsgrid/dist/jsgrid-theme.css"]
        },
        {
            "name": "multiselect",
            "assets": ["./node_modules/multiselect/js/jquery.multi-select.js", "./node_modules/multiselect/css/multi-select.css"]
        },
        {
            "name": "bootstrap-select",
            "assets": ["./node_modules/bootstrap-select/dist/js/bootstrap-select.min.js", "./node_modules/bootstrap-select/dist/css/bootstrap-select.min.css"]
        },
        {
        ...
        {
            "name": "clockpicker",
            "assets": ["./node_modules/clockpicker/dist/bootstrap-clockpicker.min.js", "./node_modules/clockpicker/dist/bootstrap-clockpicker.min.css"]
        },
        {
        ...
        {
            "name": "quill",
            "assets": ["./node_modules/quill/dist/quill.min.js", "./node_modules/quill/dist/quill.core.css",
        ...
        {
            "name": "x-editable",
            "assets": ["./node_modules/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js", "./node_modules/x-editable/dist/bootstrap3-editable/css/bootstrap-editable.css"]
        },
        {
            "name": "cropper",
            "assets": ["./node_modules/cropper/dist/cropper.min.js", "./node_modules/cropper/dist/cropper.min.css"]
        },
        {"name": "katex", "assets": ["./node_modules/katex/dist/katex.min.js"]},
        {
            "name": "dropify",
            "assets": ["./node_modules/dropify/dist/js/dropify.min.js", "./node_modules/dropify/dist/css/dropify.min.css"]
        },
        {
        ...
        {
            "name": "fancybox",
            "assets": ["./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js", "./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.css"]
        },
    ],
    font: [
...
out = folder.dist_assets + "/libs/summernote/font";
mix.copyDirectory('./node_modules/summernote/dist/font/', out);

// copy all fonts
out = folder.dist_assets + "fonts";
...
mix.sass('resources/scss/calculator.scss', folder.dist_assets + "css").minify(folder.dist_assets + "css/app.css");
mix.sass('resources/scss/additional.scss', folder.dist_assets + "css").minify(folder.dist_assets + "css/app.css");
...
var app_pages_assets = {
    js: [
        ...
        folder.src + "js/pages/catalog.init.js",
        folder.src + "js/pages/purchase.init.js",
        folder.src + "js/pages/clients.init.js",
        folder.src + "js/pages/stock.init.js",
        folder.src + "js/pages/calculator.js",
        folder.src + "js/pages/users.init.js",
        folder.src + "js/pages/company.init.js",
        folder.src + "js/pages/lots.init.js",
        folder.src + "js/pages/common.init.js",
        folder.src + "js/pages/tasks.init.js",
        folder.src + "js/pages/issuanceOfFinance.init.js",
        folder.src + "js/pages/roles.init.js",
        folder.src + "js/pages/space.init.js",
        folder.src + "js/pages/purchaseReport.init.js",
    ]
};
